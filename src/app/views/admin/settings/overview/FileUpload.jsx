...
const FileInput = (props) => {
    ...
    const [fileCount, setFileCount] = useState('Datei auswählen...')

    const handleFileInputChange = (event) => {
        setFileCount(event.target.files.length + (event.target.files.length > 1 ? " Dateien" : " Datei") + " ausgewählt")
    ...
    return (
        ...
        <FileUploadLabel>
            ...
            />
            <FileUploadSpanBefore>{'Durchsuchen'}</FileUploadSpanBefore>
